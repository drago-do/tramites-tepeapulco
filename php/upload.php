...
<body>
  ...
  <div class="main container">
    ...
    if (isset($apelidoPaterno) && isset($apellidoMaterno) && isset($nombre) && isset($calle) && isset($colonia) && isset($municipio)) {
      ...
      $resultado = $nuevaConsulta->insertarNuevaConsulta($correo, $apelidoPaterno, $apellidoMaterno, $nombre, $calle, $colonia, $municipio, $folio, $extension, $adjunto, $cuenta_predial, $comentario);
